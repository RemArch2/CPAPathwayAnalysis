...
# Title
cells.append(nbf.v4.new_markdown_cell("""# Alternative CPA Pathways Survey Analysis

**Objective:** Assess the risk to university enrollment and identify the perceived value of the graduate degree in light of new "Alternative CPA Pathways".

**Date:** Nov 21, 2025 - Dec 12, 2025
**Analyst:** Jules
"""))
...
# Load Data
cells.append(nbf.v4.new_code_cell("""# Load the data
file_path = 'Alternative CPA Pathways Survey_December 31, 2025_09.45.csv'
print(f"Loading data from {file_path}...")
# Read with header=0 to get column names
...
# Data Cleaning
cells.append(nbf.v4.new_code_cell("""# Filter for Undergrads and Grads
...
# Task A
cells.append(nbf.v4.new_markdown_cell("## Task A: The \"Cannibalization\" Risk (Undergraduate Pipeline)"))
cells.append(nbf.v4.new_code_cell("""# Map Likert Scales
# Q29 (CPA Likelihood)
q29_mapping = {
    'Very unlikely': 1,
    'Somewhat unlikely': 2,
...
# Task B
cells.append(nbf.v4.new_markdown_cell("## Task B: The \"Value Proposition\" (Graduate Student Perception)"))
cells.append(nbf.v4.new_code_cell("""# Columns Q24_1 to Q24_6
...
# Summary of Findings
# I need to read the findings from the file generated by analysis.py
try:
    with open('outputs/findings.txt', 'r') as f:
        findings_text = f.read()
except FileNotFoundError:
    findings_text = "Findings not yet generated. Run the analysis code to see results."

# Format findings text for markdown if needed, but it should be fine.
cells.append(nbf.v4.new_markdown_cell(f"""## Summary of Findings

{findings_text}

**Disclaimer:** *Data represents a point-in-time snapshot of student sentiment (Nov-Dec 2025).*
"""))
